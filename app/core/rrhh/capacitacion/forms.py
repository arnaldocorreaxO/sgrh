...
class CapacitacionForm(ModelFormEmpleado):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'institucion': forms.Select(attrs={'class': 'form-control select2', 'style': 'width: 100%;', 'data-placeholder': 'Seleccione la institución'}),
            'tipo_certificacion': forms.Select(attrs={'class': 'form-control select2', 'style': 'width: 100%;'}),
            'nombre_capacitacion': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ej: Curso de Especialización en Python'}),
            ...
            'observaciones': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Breve descripción de los temas abordados (opcional)'}),
        }
        labels = {
