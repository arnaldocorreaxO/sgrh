...
from core.rrhh.modules.documento_complementario.forms import (
    DocumentoComplementarioFilterForm,
    DocumentoComplementarioForm,
)
...
class DocumentoComplementarioList(PermissionMixin, EmpleadoScopedMixin, BaseListView):
    ...
    def get_queryset(self):
        ...
        print(
            f"Filtros -> Sucursal: {sucursal_id}, Emp: {empleado_id}, Tipo: {tipo_doc_id}, Rango: {rango_fecha}"
        )
        ...
        return qs.select_related("empleado", "tipo_documento").order_by(
            "-fecha_documento"
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.is_self_view:
            ...
            context["documento_complementario_filter_form"] = (
                DocumentoComplementarioFilterForm(self.request.GET or None)
            )
        return context
...
class DocumentoComplementarioCreate(PermissionMixin, EmpleadoScopedMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return self.enrich_context_with_empleado(
            context, prefijo="Agregar Documentos Complementarios"
        )
...
class DocumentoComplementarioUpdate(PermissionMixin, EmpleadoScopedMixin, UpdateView):
    ...
    def get_object(self, queryset=None):
        try:
            if self.is_self_view:
                ...
                return DocumentoComplementario.objects.get(
    ...
    def get_context_data(self, **kwargs):
        ...
        # Titulo con el nombre del empleado
        return self.enrich_context_with_empleado(
            context, prefijo="Modificar Documentos Complementarios"
        )
