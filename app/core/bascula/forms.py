...
class SearchForm(forms.Form):
    ...
    transporte = forms.ModelChoiceField(
        queryset=Transporte.objects.filter(activo=True), empty_label="(Todos)"
    )
    cliente = forms.ModelChoiceField(
        queryset=Cliente.objects.filter(activo=True), empty_label="(Todos)"
    )
    destino = forms.ModelChoiceField(
        queryset=Cliente.objects.filter(activo=True, ver_en_destino=True),
        empty_label="(Todos)",
    )
    ...
    producto = forms.ModelChoiceField(
        queryset=Producto.objects.none(), empty_label="(Todos)"
    )
    ...
    vehiculo = forms.ModelChoiceField(
        queryset=Vehiculo.objects.none(), empty_label="(Todos)"
    )
    ...
    chofer = forms.ModelChoiceField(
        queryset=Chofer.objects.none(), empty_label="(Todos)"
    )

    transporte.widget.attrs.update(
    ...
    class Meta:
        ...
        widgets = {
            "denominacion": forms.TextInput(
                attrs={"placeholder": "Ingrese denominacion Transporte"}
            ),
        }
...
class ClienteForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "denominacion": forms.TextInput(
                attrs={"placeholder": "Ingrese un Cliente"}
            ),
        }
...
class MarcaVehiculoForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "denominacion": forms.TextInput(
                attrs={"placeholder": "Ingrese una Marca Vehiculo"}
            ),
        }
...
class CategoriaForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "denominacion": forms.TextInput(
                attrs={"placeholder": "Ingrese una Categoria"}
            ),
        }
...
class ProductoForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "denominacion": forms.TextInput(
                attrs={"placeholder": "Ingrese un Producto"}
            ),
        }
...
class MovimientoEntradaForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["destino"].queryset = Cliente.objects.filter(
            activo=True, ver_en_destino=True
        )
        ...
        movimiento_padre = forms.ModelChoiceField(
            queryset=Movimiento.objects.none(), empty_label="(Sin movimiento asociado)"
        )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "nro_ticket": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
            "peso_entrada": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
            "movimiento_padre": forms.Select(
                attrs={
                    "class": "custom-select select2",
                    "style": "width: 100%",
                }
            ...
            "vehiculo": forms.Select(
                attrs={"class": "custom-select select2", "style": "width: 90%"}
            ),
            "chofer": forms.Select(
                attrs={"class": "custom-select select2", "style": "width: 90%"}
            ),
...
class MovimientoSalidaForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        movimiento_padre = forms.ModelChoiceField(
            queryset=qs, empty_label="(Sin movimiento asociado)"
        )
        self.fields["movimiento_padre"] = movimiento_padre
        self.fields["movimiento_padre"].required = False
        ...
        """NUMERACION TICKET"""
        max_nro_ticket = Movimiento.objects.filter(
            sucursal_id=self.instance.sucursal.id
        ...
        self.fields["vehiculo"].queryset = Vehiculo.objects.filter(
            id=self.instance.vehiculo_id
        )
        self.fields["chofer"].queryset = Chofer.objects.filter(
            id=self.instance.chofer_id
        )
        self.fields["cliente"].queryset = Cliente.objects.filter(
            id=self.instance.cliente_id
        )
        self.fields["producto"].queryset = Producto.objects.filter(
            id=self.instance.producto_id
        )
    ...
    class Meta:
        ...
        widgets = {
            ...
            # 			}
            # ),
            "peso_salida": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
            "nro_mic": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
            "nro_remision": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
            "peso_embarque": forms.TextInput(
                attrs={
                    "readonly": True,
                }
            ),
