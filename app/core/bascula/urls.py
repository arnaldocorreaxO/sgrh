...
urlpatterns = [
    ...
    path(
        "ajax_puerto_serial/<str:puerto>/",
        leer_puerto_serial,
        name="leer_puerto_serial",
    ),
    ...
    path(
        "movimiento/update/<int:pk>/<tipo_salida>/",
        MovimientoUpdateSalida.as_view(),
        name="movimiento_update_salida",
    ),
    path(
        "movimiento/update/<int:pk>/",
        MovimientoUpdate.as_view(),
        name="movimiento_update",
    ),
    path(
        "movimiento/delete/<int:pk>/",
        MovimientoDelete.as_view(),
        name="movimiento_delete",
    ),
    path(
        "movimiento/print/<int:pk>/", MovimientoPrint.as_view(), name="movimiento_print"
    ),
    # TRANSPORTE
    ...
    path(
        "transporte/update/<int:pk>/",
        TransporteUpdate.as_view(),
        name="transporte_update",
    ),
    path(
        "transporte/delete/<int:pk>/",
        TransporteDelete.as_view(),
        name="transporte_delete",
    ),
    # CLIENTE
    ...
    path(
        "clienteproducto/add/",
        ClienteProductoCreate.as_view(),
        name="clienteproducto_create",
    ),
    path(
        "clienteproducto/update/<int:pk>/",
        ClienteProductoUpdate.as_view(),
        name="clienteproducto_update",
    ),
    path(
        "clienteproducto/delete/<int:pk>/",
        ClienteProductoDelete.as_view(),
        name="clienteproducto_delete",
    ),
    # MARCA VEHICULO
    path("marcavehiculo", MarcaVehiculoList.as_view(), name="marcavehiculo_list"),
    path(
        "marcavehiculo/add/", MarcaVehiculoCreate.as_view(), name="marcavehiculo_create"
    ),
    path(
        "marcavehiculo/update/<int:pk>/",
        MarcaVehiculoUpdate.as_view(),
        name="marcavehiculo_update",
    ),
    path(
        "marcavehiculo/delete/<int:pk>/",
        MarcaVehiculoDelete.as_view(),
        name="marcavehiculo_delete",
    ),
    # VEHICULO
