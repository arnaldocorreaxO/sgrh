    ...
    fields: {
      first_name: {
        validators: {
          ...
          regexp: {
            regexp: /^([A-Z a-zÁÉÍÓÚñáéíóúÑ])+?$/i,
            message:
              "Debe ingresar su nombre y solo utilizando caracteres alfabéticos",
          },
        },
      },
      last_name: {
        validators: {
          ...
          regexp: {
            regexp: /^([A-Z a-zÁÉÍÓÚñáéíóúÑ])+?$/i,
            message:
              "Debe ingresar su apellido y solo utilizando caracteres alfabéticos",
          },
        },
      },
      dni: {
