...
class DashboardView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            #             rows = (
            #                 rows.values(
            #                     "producto__denominacion",
            #                     "cliente__denominacion",
            #                     "transporte__denominacion",
            #                 )
            #                 .filter()
            #                 .annotate(
            #                     tot_toneladas=Sum("peso_neto", output_field=FloatField()),
            ...
            #                 categorias.append(
            #                     row["producto__denominacion"] + " <br> " + text_denom + " <br> "
            #                 )
            ...
            #                 .annotate(
            #                     tot_recepcion=Sum("peso_neto", output_field=FloatField()),
            ...
            #                 rows = (
            #                     Movimiento.objects.values("fecha")
            #                     .filter(
            #                         sucursal=sucursal,
            #                         cliente=cliente_id,
            #                         destino=destino_id,
            ...
            #                 rows = (
            #                     Movimiento.objects.values("fecha__month")
            #                     .filter(
            #                         sucursal=sucursal,
            #                         cliente=cliente_id,
            #                         destino=destino_id,
            ...
            #                 mes = (
            #                     datetime.date(1900, row["fecha__month"], 1)
            #                     .strftime("%B")
            #                     .capitalize()
            #                 )
            ...
            #                 .exclude(anulado=True)
            #                 .annotate(
            #                     vehiculo_entrada_count=Count("id"),
            ...
            #                 categorias.append(
            #                     "%s <br> %s" % (row["producto__denominacion"], text_denom)
            #                 )
            #                 vehiculo_entrada_series_data.append(row["vehiculo_entrada_count"])
            #                 vehiculo_salida_series_data.append(row["vehiculo_salida_count"])
